...
class User extends Authenticatable
{
   ...
   /**
    ...
    /** Custom gas mixes saved from the Decompression Dive Planner's "My Gases" pill, up to 10 per diver. */
    public function diveGases()
    {
        return $this->hasMany(UserDiveGas::class);
    }
