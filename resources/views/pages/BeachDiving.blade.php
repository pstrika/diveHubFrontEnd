            ...
            <div class="card p-0 position-relative mt-n5 mx-1 z-index-2 mb-4">
                    ...
                    <div class="p-0 mt-0 mx-2 border-radius-lg py-3 pe-1">
                        <div style="float: left;">
                            <h2 class="card-title text-info mx-3 mt-0">Beach Diving</h2>
                        </div>
                ...
                <div class="col-md-5">
                    <div class="card p-0 position-relative mt-3 mx-3 z-index-2 mb-4">
                        ...
                        <div class="card-body mt-0">
                            <iframe id="youtubeVideo" class="img-fluid border-radius-lg" src="https://www.youtube.com/embed/vSP4AUjTmJs?si=lghl-_T1I3G8bouS&amp;controls=0;autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>
                            <p class="align-middle text-center text-sm"><b>🎥 City of Deerfield Beach</b></p>
                        </div>
                    </div>
