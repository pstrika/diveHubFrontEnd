<x-page-template bodyClass='dh-shell bg-gray-200' :SEO="$SEO">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-shell.header title="WreckWiki" />
        <!-- End Navbar -->
        ...
        <div class="container-fluid py-0">
            ...
            <div class="card p-0 position-relative mt-n5 mx-1 z-index-2 mb-4">
                    ...
                    {{--
                        Level filter and sort (W4 in the proposal). Plain links that
                        reload with ?level= and ?sort=, handled in
                        SiteController::showWrecks. Legend replaces the "(?)" modal.
                    --}}
                                    ...
                                    <tbody>
                                        @foreach($sitesWrecks as $site)    
                                            <tr style="border-bottom: 1px solid #D3D3D3;">
                                                ...
                                                <td class="w-40 align-middle text-left text-md"><b><a href="{{ route('SiteDetails') }}/{{ $site->slug ?? $site->id }}"> {{ $site->name }}</a></b></td> 
                                                <?php
