<x-page-template bodyClass='g-sidenav-show  bg-gray-200'>
                        ...
                        <div class="card-header p-0 position-relative mt-n5 mx-3 z-index-2">
                            <div class="bg-gradient-info shadow-info border-radius-lg pt-4 pb-3">
                                <div class="multisteps-form__progress">
                                    ...
                                    <button class="multisteps-form__progress-btn" type="button" title="Socials">Media</button>
                                    <button class="multisteps-form__progress-btn" type="button" title="Pricing">jj</button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form id="myForm" class="multisteps-form__form" action="{{ route('new-site-store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="multisteps-form__content">
                                        <div class="row mt-3">
                                            <div class="col-12">
                                                ...
                                                <div action="/pic-upload" class="form-control border dropzone"
                                                    id="my-dropzone"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="multisteps-form__panel pt-3 border-radius-xl bg-white h-100"
                                    ...
                                    <div class="multisteps-form__content mt-3">
                                        ...
                                        <div class="button-row d-flex mt-0 mt-md-4">
                                            <button class="btn bg-gradient-light mb-0 js-btn-prev" type="button"
                                                title="Prev">Prev</button>
                                                <button id="submit-all" class="btn bg-gradient-dark ms-auto mb-0" type="submit" title="Send">Send</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
    ...
    {{--<script>
        Dropzone.options.dropzonewidget = {
            maxFilesize: 20, // 2 MB
            acceptedFiles: ".jpeg,.jpg,.png,.webp,.tif", // Allowed extensions
    ...
    <script>
        $(document).ready(function () {
            ...
            var myDropzone = new Dropzone("#myForm", {
                url: "{{ route('upload') }}/img/sites", // Specify the server endpoint for file uploads
