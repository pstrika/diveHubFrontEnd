<x-page-template bodyClass='g-sidenav-show  bg-gray-200'>
    <x-auth.navbars.sidebar activePage="Calendars" activeItem="sharkDiving" activeSubitem=""></x-auth.navbars.sidebar>
    
    
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-auth.navbars.navs.auth pageTitle="Shark Diving Calendar {{ $currentMonthS}}-{{ $year }}"></x-auth.navbars.navs.auth>
        <!-- End Navbar -->
                ...
                <div class="row">
                        ...
                        <div class="card p-0 position-relative mt-5 mx-0 z-index-2 mb-4">
                            <div class="card-header p-0 mt-n4 mx-3">
                                <div class="bg-gradient-info shadow-info border-radius-xl py-3 pe-1">
                                    <h2 class="card-title text-white mx-4">Shark diving in south FL</h2>
                        ...
                        <div class="card card-calendar p-0 position-relative mt-4 mx-0 z-index-2 mb-0">
                            ...
                            <table class="table align-items-left mb-0 mx-3">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            <select class="btn bg-info dropdown-toggle text-white" type="button" id="filterOp" data-bs-toggle="dropdown" aria-expanded="false">
                                                ...
                                                <option value="opId=12">Jupiter Dive Center</option>
                                ...
                                <tr><td class="text-center text-sm w-1"> 
                                    <span class="badge badge-md bg-gradient-success text-white">Emerald</span>
                                    <span class="badge badge-md bg-gradient-danger text-white">PVD</span>
                                    <span class="badge badge-md bg-gradient-warning text-white">JDC</span>
                    ...
                    <div class="col-md-12">             
                        <div class="card p-0 position-relative mt-5 mx-0 z-index-2 mb-4">
                            <div class="card-header p-0 mt-n4 mx-3">
                                <div class="bg-gradient-info shadow-info border-radius-xl py-3 pe-1">
                                    <h2 class="card-title text-white mx-4">Shark Dives {{ $currentMonthS }}-{{ $year }}</h2>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
