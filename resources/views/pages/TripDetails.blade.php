                                    ...
                                    <tbody>    
                                        <tr> <td>
                                            <table class="table align-items-center mb-0">
                                                ...
                                                <td class="align-middle text-left text-lg"><b>{{ $tripDetails->showTime}}</b></td> </tr>
                                                
                                                <tr><td class="text-secondary text-end text-lg font-weight-bolder opacity-7">Availability</td>
                                                <td class="align-middle text-left text-lg"><b>{{ $tripDetails->tripFreeSpots}} spots</b></td> </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr> <td>
                                            <table class="table align-items-center mb-0">
                                                ...
                                                <td class="align-middle text-left text-wrap text-lg"><b>{{ $operator->streetAddress}}<br>{{ $operator->cityAddress}}, {{ $operator->stateAddress}} {{ $operator->zipAddress}} </b></td> </tr>

                                                <tr><td class="text-secondary text-end text-lg font-weight-bolder opacity-7">Phone</td>
                                                <td class="align-middle text-left text-lg"><b>{{ $operator->phone}}</b></td> </tr>
                                                ...
                                                @if($operator->marinaAddress)
                                                    ...
                                                    <td class="align-middle text-wrap text-lg"><b>{{ $operator->marinaAddress}}</b></td> </tr>
                                                @endif
                                                
                                                @if($operator->webSite)
                                                    <tr><td class="text-secondary text-end text-lg font-weight-bolder opacity-7">Website</td>
                                                    <td class="align-middle text-left text-lg"><b><a href="{{ $operator->webSite}}">here</a></b></td> </tr>
                                                @endif

                                                @if($operator->waiverLink)
                                                    <tr><td class="text-secondary text-end text-lg font-weight-bolder opacity-7">Online waiver</td>
                                                    <td class="align-middle text-left text-lg"><b><a href="{{ $operator->waiverLink}}">here</a></b></td> </tr>
                                                @endif
            ...
            <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 ">             
                        <div class="card p-0 position-relative mt-3 mx-3 z-index-2">
                            <div class="card-header bg-gradient-info">
                                    <h2 class="card-title text-white">Dive Site</h4>
                                        ...
                                        <tbody>
                                            ...
                                            <tr> <td>
                                                <table class="table align-items-center mb-0">
                                                    ...
                                                    <tr><td class="text-secondary text-end text-lg font-weight-bolder opacity-7">Link to book</td>
                                                    <td class="align-middle text-left text-lg"><b><a href="{{ $tripDetails->linkToBook}}">here</a></b></td> </tr>
                    ...
                    <div class="col-md-4 ">             
                        <div class="card p-0 position-relative mt-3 mx-3 z-index-2">
                            <div class="card-header bg-gradient-info">
                                    <h2 class="card-title text-white">Dive site(s)</h4>
