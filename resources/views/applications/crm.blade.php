                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 mt-md-0 mt-5">
                                <div class="card h-100">
                                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                        <div
                                            ...
                                            <a href="javascript:;" class="mx-auto my-3">
                                                <i class="material-icons text-white text-xl mb-1"
                                    ...
                                    <div
                                        class="card-body pt-1 pb-2 d-flex flex-column justify-content-center text-center">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body p-3">
                                <ul class="list-group">
                                    ...
                                    <li
                                        class="list-group-item border-0 justify-content-between ps-0 mb-2 border-radius-lg">
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                                <button
                                                    class="btn btn-icon-only btn-rounded btn-outline-success mb-0 me-3 p-3 btn-sm d-flex align-items-center justify-content-center"><i
