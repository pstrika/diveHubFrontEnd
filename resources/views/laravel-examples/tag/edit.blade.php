<x-page-template bodyClass='dh-shell bg-gray-200'>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-shell.header title="Tag Management" />
        <!-- End Navbar -->
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method='POST' action='{{ route('edit.tag', $tag) }}' class='d-flex flex-column align-items-center'>
                                @csrf

                                <div class="form-group col-12 col-md-6">
                                    <label for="exampleInputname">Name</label>
                                    <input type="name" name='name' class="form-control border border-2 p-2" id="exampleInputname" placeholder="Enter name" value="{{ old('name', $tag->name) }}">
                                    @error('name')
