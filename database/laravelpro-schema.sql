...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `certLevel` int DEFAULT NULL,
  `favOperators` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `favLocations` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `showLevel` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prefersLocation` tinyint DEFAULT NULL,
  ...
  `show_visited` tinyint DEFAULT '1',
  `deco_unit` tinyint DEFAULT '0',
  `calendar_token` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
